...
namespace OurBlog.Controllers
{
    public class BkUsersController : ElecSmoke.Controllers.BaseController
    {
        ...
        public ActionResult Create([Bind(Include = "FUSERID,FUSERNO,FUSERNAME,FUSERNICKNAME,FUSERREGTIME,FUSERLEVEL,FUSERBIRTHDAY,FUSERMOBILENO,FUSERQQNO,FUSERWXID,FUSERMAIL,FUSERSTATUS,FUSERTELNO,FPASSWORD")] user user)
        {
